                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var n = 0; n < data.length; n++) {
                            ...
                            var sampleTime = data[n].sampleTime;
                            var deviceName = data[n].deviceName;
                            var ret = "<td style='color:#ea5f5f'>" + data[n].type + "</td>";
                            var Almret="阈值未设置";
                            // if (data[n].c2H2Alm == 0) {
                            //     Almret = "<td style='color:#ea5f5f'>乙炔阈值超出</td>";
                            // } else if (data[n].c2H2Alm == 1) {
                            //     Almret = "<td style='color:#c0e76f'>正常</td>";
                            // } else if (data[n].c2H2Alm == null) {
                            //     Almret = "<td style='color:#ebdc5b'>阈值未设置</td>";
                            // }
                            var H2Almret="阈值未设置";
                            // if (data[n].h2Alm == 0) {
                            //     H2Almret = "<td style='color:#ea5f5f'>氢气阈值超出</td>";
                            // } else if (data[n].h2Alm == 1) {
                            //     H2Almret = "<td style='color:#c0e76f'>正常</td>";
                            // } else if (data[n].h2Alm == null) {
                            //     H2Almret = "<td style='color:#ebdc5b'>阈值未设置</td>";
                            // }
                            var TAlmret="阈值未设置";
                            // if (data[n].totHydcAlm == 0) {
                            //     TAlmret = "<td style='color:#ea5f5f'>总烃阈值超出</td>";
                            // } else if (data[n].totHydcAlm == 1) {
                            //     TAlmret = "<td style='color:#c0e76f'>正常</td>";
                            // } else if (data[n].totHydcAlm == null) {
                            //     TAlmret = "<td style='color:#ebdc5b'>阈值未设置</td>";
                            // }

                            html1 += "<div id='" + tableid + "' style='width:550px; float:left; margin:10px; padding:10px; border: 1px solid #ccc;background:#f8f8f8;'>";
                            html1 += "<div style='font-family:Microsoft YaHei;font-size:15;float:left;background:#9CF;width:510px;padding:20px;'>" + deviceName + "</div>";
                            ...
                            html1 += "<tr><td>甲烷(ppm)</td><td style='color:#c0e76f;'>" + data[n].ch4ppm + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
...
//            	    		html1 +="<tr><td>甲烷(ppm)</td><td>"+list[1].CH4ppm+"</td><td>"+list[0].CH4ppm+"</td></tr>";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var n = 0; n < data.length; n++) {
                            ...
                            // if (data[n].pres == 0) {
                            //     PAlmret = "压力阈值超出";
                            // } else if (data[n].pres == 1) {
                            //     PAlmret = "正常";
                            // } else if (data[n].pres == null) {
                            //     PAlmret = "阈值未设置";
                            // }
                            var ret = "<td style='color:#ea5f5f'>" + data[n].type + "</td>";
                            html1 += "<div id='" + tableid + "' style='width:550px; float:left; margin:10px; padding:10px; border: 1px solid #ccc;background:#f8f8f8;'>";
                            ...
                            html1 += "<table class='Detailtb' style='margin:auto;font-size:16px;width:100%;'>";
                            html1 += "<tr style='background-color:transparent'><th>监测量名称</th><th>检测量值</th><th> 状    态 </th><th>采集时间</th></tr>";
                            html1 += "<tr><td>温度</td><td style='color:#c0e76f;'>" + data[n].tmp + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                            html1 += "<tr><td>压力</td><td style='color:#c0e76f;'>" + data[n].pres + "</td><td>" + PAlmret + "</td><td>" + sampleTime + "</td></tr>";
                            html1 += "<tr><td>湿度</td><td style='color:#c0e76f;'>" + data[n].hum + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                            html1 += "<tr><td>状态</td>" + ret + "<td></td><td></td></tr>";
                            html1 += "</table>";
                            html1 += "</div>";
                            $("#showdata_div").append(html1);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var n = 0; n < data.length; n++) {
                                ...
                                html1 += "<table class='Detailtb' style='margin:auto;font-size:16px;width:100%;'>";
                                html1 += "<tr style='background-color:transparent'><th>监测量名称</th><th>检测量值</th><th> 状    态 </th><th>采集时间</th></tr>";
                                html1 += "<tr><td>全电流</td><td style='color:#c0e76f;'>" + data[n].totA + "</td><td>" + TOAlmret + "</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>阻性电流</td><td style='color:#c0e76f;'>" + data[n].risA + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>阻容比</td><td style='color:#c0e76f;'>" + data[n].risCaRte + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>最近落雷时间</td><td style='color:#c0e76f;'>" + data[n].lastLigTm + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>落雷次数</td><td style='color:#c0e76f;'>" + data[n].ligCnt + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>状态</td>" + ret + "<td></td><td></td></tr>";
                                html1 += "</table>";
                                html1 += "</div>";
                                $("#showdata_div").append(html1);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var n = 0; n < data.length; n++) {
                                ...
                                html1 += "<table class='Detailtb' style='margin:auto;font-size:16px;width:100%;'>";
                                html1 += "<tr style='background-color:transparent'><th>监测量名称</th><th>检测量值</th><th> 状    态 </th><th>采集时间</th></tr>";
                            html1 += "<tr><td>泄露电流</td><td style='color:#c0e76f;'>" + data[n].cGAmp + "</td><td>" + CAlmret + "</td><td>" + sampleTime + "</td></tr>";
                                // html1 += "<tr><td>夹件电流</td><td style='color:#c0e76f;'>" + data[n].amp1 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>本体主油箱磁力式油位</td><td style='color:#c0e76f;'>" + data[n].mainOil + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>本体主油箱压力式油位</td><td style='color:#c0e76f;'>" + data[n].preOil + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>有载开关油位</td><td style='color:#c0e76f;'>" + data[n].sltcOil + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>网侧绕组温度</td><td style='color:#c0e76f;'>" + data[n].tmp1 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>油面温度</td><td style='color:#c0e76f;'>" + data[n].tmp2 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>顶层油温1</td><td style='color:#c0e76f;'>" + data[n].tmp4 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>顶层油温2</td><td style='color:#c0e76f;'>" + data[n].tmp5 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>底层油温1</td><td style='color:#c0e76f;'>" + data[n].tmp6 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>底层油温2</td><td style='color:#c0e76f;'>" + data[n].tmp7 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>环境温度</td><td style='color:#c0e76f;'>" + data[n].Tmp8 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>阀侧首端套管SF6压力</td><td style='color:#c0e76f;'>" + data[n].pre1 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>阀侧末端套管SF6压力</td><td style='color:#c0e76f;'>" + data[n].pre2 + "</td><td>--</td><td>" + sampleTime + "</td></tr>";
                                html1 += "<tr><td>状态</td>" + ret + "<td></td><td></td></tr>";
                                html1 += "</table>";
                                html1 += "</div>";
                                $("#showdata_div").append(html1);
            ...
            //                     html1 += "<tr><td>局放声学水平</td><td style='color:#c0e76f;'>" + data[n].acuPaDsch + "</td><td>" + PadAlmret + "</td><td>" + list[0].acuPaDsch + "</td></tr>";
            //                     html1 += "<tr><td>局放UHF水平</td><td style='color:#c0e76f;'>" + data[n].uhfPaDsch + "</td><td>--</td><td>" + list[0].uhfPaDsch + "</td></tr>";
            //                     html1 += "<tr><td>放电相位</td><td style='color:#c0e76f;'>" +data[n].phase + "</td><td>--</td><td>" + list[0].phase + "</td></tr>";
            //                     html1 += "<tr><td>脉冲次数</td><td style='color:#c0e76f;'>" + data[n].plsNum + "</td><td>--</td><td>" + list[0].plsNum + "</td></tr>";
            //                     html1 += "<tr><td>状态</td>" + ret + "<td></td><td></td></tr>";
            //                     html1 += "</table>";
            //                     html1 += "</div>";
            //                     $("#showdata_div").append(html1);
...
function export_Word() {
    ...
    if (type == "1") {
        $.ajax({
            ...
            url: ctxPath + '/deviceHealthState/getStomDetailList?_off=' + false + "&_time=" + null,
            success: function (data) {
                debugger
                var head_data;
                head_data = [];
    ...
    if (type == "2") {
        $.ajax({
            ...
            url: ctxPath + '/deviceHealthState/getSf6DetailList?_off=' + false + "&_time=" + null,
            success: function (data) {
                var head_data;
                head_data = [];
                head_data.push(
    ...
    if (type == "3") {
        $.ajax({
            ...
            url: ctxPath + '/deviceHealthState/getSmoamDetailList?_off=' + false + "&_time=" + null,
            success: function (data) {
                var head_data, json;
                head_data = [];
                head_data.push(
                    ...
                    {"title": "状态", "value": "type"});
                tableExport_test(data, head_data, "doc", "避雷器及动作次数设备报表");
            }
        });
    }
    if (type == "4") {
        $.ajax({
            ...
            cache: false,
            type: 'POST',
            url: ctxPath + '/deviceHealthState/getScomDetailList?_off=' + false + "&_time=" + null,
    ...
    //                 {"title": "局放声学水平阈值状态", "value": "paDschAlm"},
    //                 {"title": "局放UHF水平", "value": "uhfPaDsch"},
    //                 {"title": "放电相位", "value": "phase"},
    //                 {"title": "脉冲次数", "value": "plsNum"},
    //                 {"title": "状态", "value": "type"});
    //             tableExport_test(data, head_data, "doc", "铁芯泄露电流设备报表");
    //         }
    //     });
    // }
}
